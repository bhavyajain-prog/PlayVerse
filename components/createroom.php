...
<head>
          ...
          <title>PlayVerse-CreateRoom</title>
          <link
...
<body>
          <div class="container bg-dark m-1 p-2">
                    ...
                    <div class="gameinfo p-2">
                              ...
                              <div class="code">
                               <input type="text" placeholder="Enter Room Code" class="form-control">
                               <div class="dropdown">
                              ...
                              <div class="croom d-flex justify-content-center m-3">
                              <button type="button" class="btn btn-primary w-50">Create Room</button>
                              </div>
                    </div>
          </div>
